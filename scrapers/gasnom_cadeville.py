...
class GasNom(PipelineScraper):
    source = 'gasnom-cadeville'
    api_url = 'http://www.gasnom.com/ip/CADEVILLE/'
    post_data_url = 'http://www.gasnom.com/ip/CADEVILLE/OAC.cfm'
    ...
    post_page_headers = {
        ...
        'Cookie': 'visid_incap_2551=OEm7s+EsTk2fDMfkEjLL9C97BWMAAAAAQUIPAAAAAAD6tEen2HOpuoYIBL2I7La6; _ga=GA1.2.1051632509.1661303600; _gid=GA1.2.833989407.1661303600; MIGCSHIPPER9384=ANONYMOUS; SHIPPER=ANONYMOUS; CFID=13515159; CFTOKEN=113e5fc9b94cbd91-3F9D0B71-EA3F-1BA0-23F0C3576EC0A6DE; incap_ses_969_2551=PBP0CmmKKCrjqD9YDJVyDRD0BmMAAAAAINIuIUnrC8RVvZ+bRFnBfA==',
        'Host': 'www.gasnom.com',
        'Origin': 'http://www.gasnom.com',
        'Referer': 'http://www.gasnom.com/ip/CADEVILLE/transposting.cfm?id=1',
