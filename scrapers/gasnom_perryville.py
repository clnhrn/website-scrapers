...
class GasNom(PipelineScraper):
    source = 'gasnom-perryville'
    api_url = 'http://www.gasnom.com/ip/perryville/'
    post_data_url = 'http://www.gasnom.com/ip/perryville/OAC.cfm'
    ...
    post_page_headers = {
        ...
        'Cookie': 'visid_incap_2551=OEm7s+EsTk2fDMfkEjLL9C97BWMAAAAAQUIPAAAAAAD6tEen2HOpuoYIBL2I7La6; _ga=GA1.2.1051632509.1661303600; _gid=GA1.2.833989407.1661303600; MIGCSHIPPER9384=ANONYMOUS; SHIPPER=ANONYMOUS; incap_ses_969_2551=PBP0CmmKKCrjqD9YDJVyDRD0BmMAAAAAINIuIUnrC8RVvZ+bRFnBfA==; CFID=13515944; CFTOKEN=550d8f1678a8992e-4105A5B3-F2D5-3DF7-E9CABDC6388DBEA7; _gat=1',
        'Host': 'www.gasnom.com',
        'Origin': 'http://www.gasnom.com',
        'Referer': 'http://www.gasnom.com/ip/perryville/transposting.cfm?id=1',
